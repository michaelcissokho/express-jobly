...
describe("GET /companies", function () {
  ...
  /// adding test for getting search results with invalid min greater than max
  test('fails because min greater than max', async function (){
  ...
  test('fails because of invalid param', async function (){
    const resp = await request(app).get('/companies?wrong=wrong')
    expect(resp.statusCode).toEqual(400)
  })
